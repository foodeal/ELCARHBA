...
export function PartnerSignUp(): JSX.Element {
  ...
  return (
    ...
    >
      <Grid
        ...
        direction='column'
      >
        <div className={styles.title}>Fiche d&apos;inscription prestataire</div>
        <Grid>
          <Form
            formId={FormIdEnum.SignupPartner}
            initialValues={{}}
            onSubmit={submitForm}
          >
            <Grid
            ...
            >
              ...
              {renderFields(SignupFormNamesEnum.SocialReason)}
              ...
              {renderFields(SignupFormNamesEnum.ServiceType)}
              {renderFields(SignupFormNamesEnum.ServiceType)}

              {renderFields(SignupFormNamesEnum.CommercialRegister)}
              {renderFields(SignupFormNamesEnum.Cin)}
              {renderFields(SignupFormNamesEnum.ConditionContract)}
